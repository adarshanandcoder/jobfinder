...
import { applyToAJob } from "@/api/apiApplications";
...
const schema = z.object({
  experience: z
    ...
    .int(),
  skills: z.string().min(1, { message: "Skills are mandatory" }),
    ...
    <Drawer open={applied ? false : undefined}>
      <DrawerTrigger asChild>
        <Button
          ...
          size="lg"
          className={` ${job?.isOpen ? "default" : "destructive"}`}
        >
      ...
      <DrawerContent>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4 p-4 pb-2">
          <Input
            type="number"
          ...
          {loadingApply && <BarLoader width={"100%"} color="ef4444" />}
